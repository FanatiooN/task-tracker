...
func (x *RegisterByEmailResponse) GetAccessToken() string {
	if x != nil {
...
func (x *RegisterByEmailResponse) GetRefreshToken() string {
	if x != nil {
...
func (x *LoginByEmailResponse) GetAccessToken() string {
	if x != nil {
		return x.AccessToken
	}
	return ""
...
func (x *LoginByEmailResponse) GetRefreshToken() string {
	if x != nil {
		return x.RefreshToken
	}
	return ""
...
func (x *LoginByOAuthRequest) GetProvider() string {
	if x != nil {
		return x.Provider
	}
	return ""
...
func (x *LoginByOAuthRequest) GetRedirectUri() string {
	if x != nil {
...
const file_proto_auth_auth_proto_rawDesc = "" +
	...
	"\x14LoginByEmailResponse\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken\"h\n" +
	"\x13LoginByOAuthRequest\x12\x1a\n" +
	...
	"\rLogoutRequest\x12#\n" +
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken2\xb3\x03\n" +
	"\vAuthService\x12N\n" +
	"\x0fRegisterByEmail\x12\x1c.auth.RegisterByEmailRequest\x1a\x1d.auth.RegisterByEmailResponse\x12E\n" +
	"\fLoginByEmail\x12\x19.auth.LoginByEmailRequest\x1a\x1a.auth.LoginByEmailResponse\x12E\n" +
	"\fLoginByOAuth\x12\x19.auth.LoginByOAuthRequest\x1a\x1a.auth.LoginByOAuthResponse\x12E\n" +
	"\fRefreshToken\x12\x19.auth.RefreshTokenRequest\x1a\x1a.auth.RefreshTokenResponse\x12H\n" +
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponse\x125\n" +
	"\x06Logout\x12\x13.auth.LogoutRequest\x1a\x16.google.protobuf.EmptyB\x19Z\x17task-tracker/proto/authb\x06proto3"
...
var file_proto_auth_auth_proto_goTypes = []any{
	(*RegisterByEmailRequest)(nil),  // 0: auth.RegisterByEmailRequest
	(*RegisterByEmailResponse)(nil), // 1: auth.RegisterByEmailResponse
	(*LoginByEmailRequest)(nil),     // 2: auth.LoginByEmailRequest
	(*LoginByEmailResponse)(nil),    // 3: auth.LoginByEmailResponse
	(*LoginByOAuthRequest)(nil),     // 4: auth.LoginByOAuthRequest
	(*LoginByOAuthResponse)(nil),    // 5: auth.LoginByOAuthResponse
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	0,  // 0: auth.AuthService.RegisterByEmail:input_type -> auth.RegisterByEmailRequest
	2,  // 1: auth.AuthService.LoginByEmail:input_type -> auth.LoginByEmailRequest
	4,  // 2: auth.AuthService.LoginByOAuth:input_type -> auth.LoginByOAuthRequest
	...
	1,  // 6: auth.AuthService.RegisterByEmail:output_type -> auth.RegisterByEmailResponse
	3,  // 7: auth.AuthService.LoginByEmail:output_type -> auth.LoginByEmailResponse
	5,  // 8: auth.AuthService.LoginByOAuth:output_type -> auth.LoginByOAuthResponse
	...
	11, // 11: auth.AuthService.Logout:output_type -> google.protobuf.Empty
